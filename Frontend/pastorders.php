...
if(isset($_SESSION['username'])) {
    ...
    $stt = $db->prepare("SELECT * FROM orders WHERE username = ? ORDER BY id ASC");
    ...
    <head>
        ...
        <title>NJIT DINER | Past Orders</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                $i=1;
                foreach ($rows as $row){
                    $date = date('m/d/Y H:i:s', $row['created_at']);
                    echo "<span style='font-size: 20px'>{$i} . {$row['menu_name']}</span><br>";
                    $i+=1;
                }
                ?>
            </div>
