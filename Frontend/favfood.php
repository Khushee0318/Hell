...
//BLH8839OUtmsh06PoUmvYv1aKVeRp1lwz7Bjsnqmo9vVgjhrlA
    ...
    $stt = $db->prepare("SELECT * FROM food WHERE username = ? ORDER BY food ASC");
...
<head>
    ...
    <title>NJIT DINER | Favourite food</title>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            $i=1;
            foreach ($rows as $row){
                echo "<span style='font-size: 20px'>{$i} . {$row['food']}</span><br>";
                $i+=1;
            }
            ?>
        </div>
